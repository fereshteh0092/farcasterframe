...
var toFarcasterTime = (time) => {
  if (time < FARCASTER_EPOCH) {
    return (0, import_neverthrow.err)(new HubError("bad_request.invalid_param", "time must be after Farcaster epoch (01/01/2022)"));
  }
...
var validateFname = (fnameP) => {
  ...
  if (fnameP instanceof Uint8Array) {
    ...
    if (fromBytes2.isErr()) {
      return (0, import_neverthrow6.err)(fromBytes2.error);
    }
